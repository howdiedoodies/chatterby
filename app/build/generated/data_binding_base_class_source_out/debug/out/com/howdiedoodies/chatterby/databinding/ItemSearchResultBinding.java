...
public final class ItemSearchResultBinding implements ViewBinding {
  ...
  @NonNull
  public final TextView usernameItemText;

  private ItemSearchResultBinding(@NonNull LinearLayout rootView, @NonNull Button btnAdd,
      @NonNull TextView usernameItemText) {
    this.rootView = rootView;
    this.btnAdd = btnAdd;
    this.usernameItemText = usernameItemText;
  }
  ...
  public static ItemSearchResultBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.username_item_text;
      TextView usernameItemText = ViewBindings.findChildViewById(rootView, id);
      if (usernameItemText == null) {
        break missingId;
      }

      return new ItemSearchResultBinding((LinearLayout) rootView, btnAdd, usernameItemText);
    }
